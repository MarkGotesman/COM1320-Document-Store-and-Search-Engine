...
public class S4_DocumentAPITest {
    ...
    //STAGE 4 tests
    @Test
    public void stage5GetLastUseTimeExists()throws URISyntaxException {
    ...
    @Test
    public void stage5SetLastUseTimeExists()throws URISyntaxException {
        URI uri = new URI("https://this.com");
        try {
